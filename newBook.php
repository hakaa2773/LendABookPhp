...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <!-- partial -->
      ...
      <div class="container-fluid">
        <h1 class="display-2"><center><B>New Book</B></center></h1>
            <form action="php/addBook.php" method="post">
             
                    <div class="mb-3 row">
                      <label for="book_name" class="col-sm-2 col-form-label">Book Namw</label>
                          <div class="col-sm-10">
                            <input type="text"  name="book_name" value="" class="form-control">
                          </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="ISBM" class="col-sm-2 col-form-label">ISBM</label>
                          <div class="col-sm-10">
                            <input type="text"  name="ISBM" value="" class="form-control">
                          </div>
                    </div> 
                    <div class="mb-3 row">
                    ...
                    <button class="btn btn-primary" type="submit" name="save">Add Books</button>         
