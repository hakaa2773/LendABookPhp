...
<h1 class="text-center" >Librarian View Book</h1>
<?php
session_start();
...
function getBookBorrow() {
document.location.href = "newBookBorrow.php?id=<?php echo $row["id"]; ?>";
}
</script>
<a href="#" onClick="getBookBorrow()">Reserve</a>
</td>
