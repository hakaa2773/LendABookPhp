...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <!-- partial -->
      ...
      <div class="container-fluid">
        <h1 class="display-2"><center><B>New Book Comment</B></center></h1>
            <form action="php/bookComment.php?id=<?php echo($id)?>" method="post">
             
                    <div class="mb-3 row">
                      <label for="book_comment" class="col-sm-2 col-form-label">Comment</label>
                          <div class="col-sm-10">
                            <textarea type="text"  name="book_comment" value="" class="form-control"></textarea> 
                          </div>
                    </div>                       
