...
<?php
$db = mysqli_connect('localhost', 'root', '', 'lendabook');
$results = mysqli_query($db, "SELECT  tbl_video.video_name, tbl_customer.email FROM tbl_video_reserve 
INNER JOIN tbl_video ON tbl_video_reserve.video_id =tbl_video.id 
INNER JOIN tbl_customer ON tbl_video_reserve.customer_id = tbl_customer.customer_id;");
?>
