...
<h1 class="text-center" >View Video favorite</h1>
<body id="page-top">
<?php
...
FROM tbl_favorite_video
INNER JOIN tbl_video ON tbl_favorite_video.video_id=tbl_video.id WHERE customer_id ='$customer_id';"); ?>
