...
<h1 class="text-center" >View Book favorite</h1>
<body id="page-top">
<?php
...
FROM tbl_favorite_books
INNER JOIN tbl_book ON tbl_favorite_books.book_id=tbl_book.id WHERE customer_id ='$customer_id';"); ?>
