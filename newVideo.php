...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <!-- partial -->
      ...
      <div class="container-fluid">
        <h1 class="display-2"><center><B>New Video</B></center></h1>
            <form action="php/addVideo.php" method="post">
             
                    <div class="mb-3 row">
                      <label for="video_name" class="col-sm-2 col-form-label">Video Namw</label>
                          <div class="col-sm-10">
                            <input type="text"  name="video_name" value="" class="form-control">
                          </div>
                    </div>
                    <div class="mb-3 row">
                      <label for="video_age_restrictions" class="col-sm-2 col-form-label">Age Restrictions</label>
                          <div class="col-sm-10">
                            <input type="text"  name="video_age_restrictions" value="" class="form-control">
                          </div>
                    </div> 
                    <div class="mb-3 row">
                      <label for="number_of_copies" class="col-sm-2 col-form-label">Number Of Copys</label>
                          <div class="col-sm-10">
                            <input type="text"  name="number_of_copies" value="" class="form-control">
                          </div>
                    </div> 

                    <button class="btn btn-primary" type="submit" name="save">Add Video</button>         
